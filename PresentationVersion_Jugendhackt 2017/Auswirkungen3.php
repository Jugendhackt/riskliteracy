  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1>Manipulation durch Graphen:</h1>
        <img src="./misleading2_cumulative.png" alt= "why isnt this shit working?">
        <p><a class="btn btn-primary btn-lg" href="./Auswirkungen4.php" role="button"> weiter &raquo;</a></p>
        <p class="lead"></p>
      </div>
