  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1>Crediting:</h1>
        <p class="lead">Dieses Projekt wurde in umgekehrter alphabetischer Reihenfolge von denFolgenden erschaffen:<br>
        Theresa Krifka-Dobes, Lydia Krifka-Dobes, Manas Goyal, Quillan Conn <br>
      besonderer Dank geht an: Björn Ternes und Jonas Hummel</p>
      </div>
