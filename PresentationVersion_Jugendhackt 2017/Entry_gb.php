  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1>GB Vorfälle:</h1>
        <p class="lead">The credit for this project goes to the following in reverse alphabetical order:<br>
        Theresa Krifka-Dobes, Lydia Krifka-Dobes, Manas Goyal, Quillan Conn</p>
      </div>
